...
const TimeSelectionComponent = (props) => {
    ...
    return (
        <View style={{ flexDirection: "row", justifyContent: "space-between" }}>
            <CurvedButton style={selectedHour === 0 ? selectedHourStyle : timeSelectionStyles.hourButtonStyle} title={options[0]} onPress={() => {
                setSelectedHour(0);
                props.setSelectedHour(options[0]);
            }} />
            <CurvedButton style={selectedHour === 1 ? selectedHourStyle : timeSelectionStyles.hourButtonStyle} title={options[1]} onPress={() => {
                setSelectedHour(1);
                props.setSelectedHour(options[1]);
            }} />
            <CurvedButton style={selectedHour === 2 ? selectedHourStyle : timeSelectionStyles.hourButtonStyle} title={options[2]} onPress={() => {
                setSelectedHour(2);
                props.setSelectedHour(options[2]);
            }} />
            <CurvedButton style={selectedHour === 3 ? selectedHourStyle : timeSelectionStyles.hourButtonStyle} title={options[3]} onPress={() => {
                setSelectedHour(3);
