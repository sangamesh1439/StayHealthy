...
import { Text, ImageBackground, FlatList, View, Image, ScrollView, Alert } from 'react-native';
...
const RestaurantDetailsComponent = (props) => {
    const { moreImages, name, description, reviews, moreDescription, time } = props.navigation.state.params.restaurant;
        ...
        <View style={{ backgroundColor: colors.WHITE_LIGHT, flex: 1 }}>
            ...
            <View style={{ height: 70, flexDirection: "row", backgroundColor: colors.WHITE, alignItems: "center", justifyContent: "space-around" }}>
                ...
                <View >
                    ...
                    />
                    <Text style={{ color: colors.GREEN, textAlign: "center" }}>{reviews} people</Text>
                </View>
            ...
            <MakeReservationModal restaurant={props.navigation.state.params.restaurant} visible={makeReservationModalVisible} hideModal={() => {
